...
class MeterReading(Base):
    ...
    current_meter: Mapped[int] = mapped_column(Integer)
    previous_meter: Mapped[int | None] = mapped_column(Integer, default=None)
    usage: Mapped[int | None] = mapped_column(Integer, default=None)
